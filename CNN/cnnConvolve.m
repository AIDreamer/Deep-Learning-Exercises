...
for imageNum = 1:numImages
  for featureNum = 1:numFeatures
    ...
    % Feature bank
    featureBank = WT(featureNum,:);
    for channel = 1:3

      % Obtain the feature (patchDim x patchDim) needed during the convolution
      % ---- YOUR CODE HERE ----
      feature = featureBank(1,patchSize*(channel-1)+1 : patchSize*channel); % You should replace this
      feature = reshape(feature,8,8);
      % ------------------------
    ...
    % ---- YOUR CODE HERE ----
    convolvedImage = convolvedImage + bMean(featureNum,1);
